...
def main():
    ...
    operating_inputs = {'current_density': current_density,
                        'T_des': [None, 343.15, None, None, None, None],
                        'Pa_des': [None, 2.0e5, None, None, None, None],
                        'Pc_des': [None, 2.0e5, None, None, None, None],
                        'Sa': [None, 4.0, None, None, None, None],
                        'Sc': [None, 4.0, None, None, None, None],
                        'Phi_a_des': [None, 0.5, None, None, None, None],
                        'Phi_c_des': [None, 0.3, None, None, None, None],
                        'y_H2_in': [None, y_H2_in_1, None, None, None, None]}


    pola_current_parameters_1['i_max_pola'] = 10000
    ...
    accessible_physical_parameters = {'Aact': 250e-4, 'nb_cell': 200, 'Hagc': Hagc, 'Hcgc': Hcgc, 'Wagc': Wagc,
                                      'Wcgc': Wcgc, 'Lgc': Lgc, 'nb_channel_in_gc': nb_channel_in_gc, 'Ldist': Ldist,
                                      'Lm': 30e-6, 'A_T_a': A_T_a, 'A_T_c': A_T_c, 'Vasm': Vasm, 'Vcsm': Vcsm,
                                      'Vaem': Vaem, 'Vcem': Vcem}
    undetermined_physical_parameters = {'Hgdl': Hgdl, 'Hmpl': Hmpl, 'Hmem': Hmem, 'Hacl': Hacl,
                                        ...
                                        'i0_c_ref': 10.0, 'kappa_co': kappa_co, 'kappa_c': kappa_c, 'C_scl': C_scl}
